...
namespace Chevron\HTTP\Requests;
...
class BaseRequest {
	 ...
	 * @return Chevron\HTTP\Requests\BaseRequest
	 */
	 ...
	 * @return string
	 */
	function rebuild(array $params, $preserve = true ){
	 ...
	 * @param \Chevron\HTTP\Requests\BaseRequest $request The object to reconstitute
	 * @return string
	 */
	static function build_url(\Chevron\HTTP\Requests\BaseRequest $request){
