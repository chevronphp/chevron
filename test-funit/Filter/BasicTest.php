...
FUnit::test("Basic::sanitize() for a scalar value", function(){
...
FUnit::test("Basic::sanitize() for an array", function(){
	$data = array(
...
FUnit::test("Basic::sanitize() recursively over an array", function(){
	$data = array(
		0        => "4e864\n4e99\x083e422743\x0739ebf\x0D7504a\x1A893b0",
		"string" => "4e864\n4e993\x08e422743\x0739ebf\x0D7504a\x1A893b0",
		"array" => array(
